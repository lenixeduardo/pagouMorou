...
export const Route = createFileRoute("/buscar")({
  loader: ({ context }) => context.queryClient.ensureQueryData(apartmentsQueryOptions()),
  head: () => ({
    meta: [
...
function SearchPage() {
  ...
  const { data: apartments = [], isLoading } = useQuery(apartmentsQueryOptions());
  ...
  const filteredApartments = useMemo(() => {
    return apartments.filter((apt) => {
      const matchesSearch =
        ...
        apt.address.neighborhoodName.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  }, [apartments, searchTerm, activeFilter]);
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Os favoritos da nossa comunidade nesta semana.
              </p>
            </div>
            <div className="flex items-center gap-2">
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Mobilidade e rapidez para o seu dia a dia.
              </p>
            </div>
            <div className="flex items-center gap-2">
              <Button variant="ghost" size="icon" className="rounded-full border border-border">
        ...
        <section className="mb-20">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                As últimas oportunidades publicadas hoje.
              </p>
            </div>
            <div className="flex items-center gap-2">
              <Button variant="ghost" size="icon" className="rounded-full border border-border">
